...
public class InventarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.proyecto.InventarioPK[ idInventario=" + idInventario + ", productoidProducto=" + productoidProducto + ", proveedoridProveedor=" + proveedoridProveedor + ", proveedortipoDeIdentificacion=" + proveedortipoDeIdentificacion + " ]";
    }

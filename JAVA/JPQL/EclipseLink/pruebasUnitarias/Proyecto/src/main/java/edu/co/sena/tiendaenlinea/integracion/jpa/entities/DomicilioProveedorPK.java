...
public class DomicilioProveedorPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.proyecto.DomicilioProveedorPK[ proveedoridProveedor=" + proveedoridProveedor + ", proveedortipoDeIdentificacion=" + proveedortipoDeIdentificacion + " ]";
    }
